...
def _group(s, monetary):
    ...

def _strip_padding(s, amount):
    ...

def _format(percent, value, grouping, monetary, *additional):
    ...

def _localize(formatted, grouping, monetary):
    ...
...
def localize(string, grouping, monetary):
